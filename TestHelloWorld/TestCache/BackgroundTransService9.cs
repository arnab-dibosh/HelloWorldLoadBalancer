...
namespace TestCache
{
    public class BackgroundTransService9 : IHostedService, IDisposable
    {
        private Timer _timer;
        private int executionCount = 0;
        private readonly ILogger<BackgroundTransService9> _logger;
        private IIDTPTransCache _idtpTransCache;
        private string lastStoredValue = String.Empty;

        public BackgroundTransService9(ILogger<BackgroundTransService9> logger, IIDTPTransCache idtpTransCache)
        {
            //_logger = logger;
