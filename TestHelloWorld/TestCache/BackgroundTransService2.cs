...
namespace TestCache
{
    public class BackgroundTransService2 : IHostedService, IDisposable
    {
        private Timer _timer;
        private int executionCount = 0;
        private readonly ILogger<BackgroundTransService2> _logger;
        private IIDTPTransCache _idtpTransCache;
        private string lastStoredValue = String.Empty;

        public BackgroundTransService2(ILogger<BackgroundTransService2> logger, IIDTPTransCache idtpTransCache)
        {
            //_logger = logger;
