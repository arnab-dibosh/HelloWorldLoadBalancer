...
namespace TestCache
{
    public class BackgroundTransService6 : IHostedService, IDisposable
    {
        private Timer _timer;
        private int executionCount = 0;
        private readonly ILogger<BackgroundTransService6> _logger;
        private IIDTPTransCache _idtpTransCache;
        private string lastStoredValue = String.Empty;

        public BackgroundTransService6(ILogger<BackgroundTransService6> logger, IIDTPTransCache idtpTransCache)
        {
            //_logger = logger;
