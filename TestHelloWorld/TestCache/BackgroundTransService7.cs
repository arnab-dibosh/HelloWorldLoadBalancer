...
namespace TestCache
{
    public class BackgroundTransService7 : IHostedService, IDisposable
    {
        private Timer _timer;
        private int executionCount = 0;
        private readonly ILogger<BackgroundTransService7> _logger;
        private IIDTPTransCache _idtpTransCache;
        private string lastStoredValue = String.Empty;

        public BackgroundTransService7(ILogger<BackgroundTransService7> logger, IIDTPTransCache idtpTransCache)
        {
            //_logger = logger;
