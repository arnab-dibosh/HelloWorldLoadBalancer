...
namespace TestCache
{
    public class BackgroundTransService4 : IHostedService, IDisposable
    {
        private Timer _timer;
        private int executionCount = 0;
        private readonly ILogger<BackgroundTransService4> _logger;
        private IIDTPTransCache _idtpTransCache;
        private string lastStoredValue = String.Empty;

        public BackgroundTransService4(ILogger<BackgroundTransService4> logger, IIDTPTransCache idtpTransCache)
        {
            //_logger = logger;
