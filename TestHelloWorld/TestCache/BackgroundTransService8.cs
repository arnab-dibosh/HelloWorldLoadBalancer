...
namespace TestCache
{
    public class BackgroundTransService8 : IHostedService, IDisposable
    {
        ...
        public BackgroundTransService8(ILogger<BackgroundTransService8> logger, IIDTPTransCache idtpTransCache)
        {
            //_logger = logger;
