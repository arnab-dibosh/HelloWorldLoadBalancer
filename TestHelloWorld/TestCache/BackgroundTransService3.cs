...
namespace TestCache
{
    public class BackgroundTransService3 : IHostedService, IDisposable
    {
        private Timer _timer;
        private int executionCount = 0;
        private readonly ILogger<BackgroundTransService3> _logger;
        private IIDTPTransCache _idtpTransCache;
        private string lastStoredValue = String.Empty;

        public BackgroundTransService3(ILogger<BackgroundTransService3> logger, IIDTPTransCache idtpTransCache)
        {
            //_logger = logger;
